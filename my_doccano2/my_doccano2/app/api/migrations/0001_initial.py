# Generated by Django 2.0.1 on 2019-10-12 02:41
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parents', models.ForeignKey(default='默认值', on_delete=django.db.models.deletion.SET_DEFAULT, to=settings.AUTH_USER_MODEL, verbose_name='领导')),
            ],
            options={
                'verbose_name': '用户',
        ...
        migrations.AddField(
            model_name='project',
            name='users',
            field=models.ManyToManyField(through='api.Project_User', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='user',
            name='role',
